defmodule Issues.TableFormatter do
  ...
  @doc """
  Takes a list of row data, where each row is a HashDict, ad a list of headers.
  Prints a table to STDOUT of the data from each row identified by each header.
  That is, each header identifies a column, and those columns are extracted adn
  ...
  column, returna list containing the maximum width of each column
  ...
  hyphens, width + signs where the vertical bar between the column goes.
  ...
  @doc """
  Given a list containing rows of data, a list containing the headers selectors,
